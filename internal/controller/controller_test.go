...
func TestProportionalOnly(t *testing.T) {
	...
	c := controller.New(controller.ControllerParams{Kp: 1.0, Min: 0, Max: 100, IClamp: 20, Setpoint: 15.0})
...
func TestOutputClamped(t *testing.T) {
	...
	c := controller.New(controller.ControllerParams{Kp: 2.0, Min: 0.5, Max: 50, IClamp: 20, Setpoint: 50.0})
...
func TestMinimumClamp(t *testing.T) {
	...
	c := controller.New(controller.ControllerParams{Kp: 1.0, Min: 0.5, Max: 50, IClamp: 20, Setpoint: 15.0})
...
func TestIntegralAntiWindup(t *testing.T) {
	...
	c := controller.New(controller.ControllerParams{Ki: 1.0, Min: 0, Max: 100, IClamp: 20, Setpoint: 15.0})
	for i := 0; i < 20; i++ {
...
func TestDerivative(t *testing.T) {
	...
	c := controller.New(controller.ControllerParams{Kd: 1.0, Min: -100, Max: 100, IClamp: 20, Setpoint: 15.0})
...
func TestReset(t *testing.T) {
	c := controller.New(controller.ControllerParams{Kp: 1.0, Ki: 1.0, Kd: 1.0, Min: 0, Max: 100, IClamp: 20, Setpoint: 15.0})
	...
	c2 := controller.New(controller.ControllerParams{Kp: 1.0, Ki: 1.0, Kd: 1.0, Min: 0, Max: 100, IClamp: 20, Setpoint: 15.0})
...
func TestSetSetpoint(t *testing.T) {
	c := controller.New(controller.ControllerParams{Kp: 1.0, Min: 0, Max: 100, IClamp: 20, Setpoint: 10.0})
...
func TestNewPanicsMinGtMax(t *testing.T) {
	...
	controller.New(controller.ControllerParams{Kp: 1.0, Min: 100, Max: 50, IClamp: 20, Setpoint: 15.0})
}
...
func TestNewPanicsNegativeIClamp(t *testing.T) {
	...
	controller.New(controller.ControllerParams{Kp: 1.0, Min: 0, Max: 100, IClamp: -1, Setpoint: 15.0})
}
